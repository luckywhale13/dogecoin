...
Gitian signatures for each release are added to https://github.com/luckywhale13/gitian.sigs.

`gitian-build.sh` will create signatures inside `gitian-output/sigs/` folder. Create a pull request to [dogecoin/gitian.sigs](https://github.com/luckywhale13/gitian.sigs) to publish your signatures, the `.assert` and `.assert.sig` files.
