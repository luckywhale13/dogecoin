...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/luckywhale13/dogecoin/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/luckywhale13/dogecoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/luckywhale13/dogecoin/pull/7415) for an example.
...
- Detached signatures will then be committed to the [dogecoin-detached-sigs](https://github.com/luckywhale13/dogecoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Create a [new GitHub release](https://github.com/luckywhale13/dogecoin/releases/new) with a link to the archived release notes.
